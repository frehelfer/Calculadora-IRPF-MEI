...
accordionHeaders.forEach((accordionHeader) => {
	accordionHeader.addEventListener('click', () => {
		...
		if (accordionHeader.classList.contains('active-header')) {
			...
			accordionIcon.style.content = 'url(/expand_less_FILL0_wght400_GRAD200_opsz48.svg)';
		} else {
			accordionContent.style.maxHeight = '0px';
			accordionIcon.style.content = 'url(/expand_more_FILL0_wght400_GRAD200_opsz48.svg)';
		}
	});
});
